...
class Confirmation(discord.ui.View):
    ...
    @discord.ui.button(emoji="♻️", label='Régénérer mon avatar', style=discord.ButtonStyle.red, disabled=False)
    async def change_avatar(self, interaction: discord.Interaction, button: discord.ui.Button):
        self.action = False
        self.interaction = interaction
        self.stop()

    @discord.ui.button(emoji="✅", label='Valider', style=discord.ButtonStyle.grey, disabled=False)
